...
void generuotiFaila(int skaiciuss, const string& aplankas) {
    ...
    string failoPavadinimas=aplankas + "/studentai_" + std::to_string(skaiciuss) + ".txt";
